import { Settings as currency } from "../core/contains/settings";
...
export class DonateForm {
  ...
  static TextObject = {
    ...
    InputLabel: `Введите сумму в ${currency.currency}`,
  };
  ...
  updateTotalAmount(newAmount) {
    this.#totalAmountHTML.textContent = `${newAmount}${currency.currency}`;
  }
